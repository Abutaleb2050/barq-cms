...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description_ar: Schema.Attribute.RichText;
    description_en: Schema.Attribute.RichText;
    feature1_label_ar: Schema.Attribute.String;
    feature1_label_en: Schema.Attribute.String;
    feature2_label_ar: Schema.Attribute.String;
    feature2_label_en: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiShowcaseSlideShowcaseSlide
  extends Struct.CollectionTypeSchema {
  collectionName: 'showcase_slides';
  info: {
    displayName: 'Showcase Slide';
    pluralName: 'showcase-slides';
    singularName: 'showcase-slide';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    keyword_ar: Schema.Attribute.String;
    keyword_en: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::showcase-slide.showcase-slide'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    address_ar: Schema.Attribute.String;
    address_en: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
...
export interface ApiVisionVision extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mission_ar: Schema.Attribute.String;
    mission_en: Schema.Attribute.String;
    positioning_ar: Schema.Attribute.String;
    positioning_en: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vision_ar: Schema.Attribute.String;
    vision_en: Schema.Attribute.String;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::showcase-slide.showcase-slide': ApiShowcaseSlideShowcaseSlide;
